...
{
	cgogn::io::import_height_map<Vec3>(map_, surface_mesh);
...
void Viewer::keyPressEvent(QKeyEvent *ev)
{
	switch (ev->key())
	{
		...
		case Qt::Key_X:
		{
			...
			cgogn::io::export_surface(map_, cgogn::io::ExportOptions("moderbach.off", {vertorb, "position"}, {}, false, false));
			break;
		}
		default:
			break;
...
void Viewer::init()
{
	...
	{
		return cgogn::color_map_BCGYR(n[2]);
	});
